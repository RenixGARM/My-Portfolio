                        ...
                        if (hasMockup) {
                            return (
                                <div key={work.id} className="work-card group relative block w-full py-20 overflow-hidden">
                                    ...
                                    {/* Titles & Saber Más - Below on Mobile, Hover Overlay on Desktop */}
                                    <div className="relative md:absolute md:inset-x-0 md:bottom-0 p-4 md:p-12 flex flex-col md:justify-end items-center pointer-events-none z-20 mt-8 md:mt-0">
                                        <div className="translate-y-0 opacity-100 md:translate-y-4 md:opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out bg-transparent md:bg-background/80 backdrop-blur-none md:backdrop-blur-md p-0 md:p-8 rounded-none md:rounded-2xl border-none md:border md:border-foreground/5 flex flex-col items-center pointer-events-auto shadow-none w-full md:w-auto mx-auto mb-4 md:mb-0">
                                            <h3 className="text-2xl md:text-3xl font-display font-light text-center">{work.title}</h3>
                                            <p className="text-foreground/80 md:text-foreground font-sans font-normal text-center mt-3 mb-6 md:mt-2 md:mb-4">{work.description}</p>
                                            <button onClick={(e) => { e.stopPropagation(); setSelectedProject(work); }} className="px-6 py-3 md:px-6 md:py-2 bg-foreground text-background text-sm font-medium rounded-full hover:scale-105 transition-transform w-[80%] md:w-auto">
                                                Saber más
                                            </button>
                                        </div>
                                    </div>
                        ...
                        return (
                            <div key={work.id} className="work-card group relative block w-full overflow-hidden bg-container rounded-2xl md:rounded-3xl aspect-[16/9] md:aspect-[21/9]">
                                ...
                                <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-end pointer-events-none z-20">
                                    <div className="translate-y-0 opacity-100 md:translate-y-4 md:opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out pointer-events-auto">
                                        <div className="flex flex-col md:flex-row justify-between items-start gap-4 mt-8">
                                            ...
                                            <div className="flex flex-col items-start gap-4">
                                                <p className="text-foreground/90 md:text-foreground font-sans font-normal md:max-w-xs">{work.description}</p>
                                                <button onClick={(e) => { e.stopPropagation(); setSelectedProject(work); }} className="px-6 py-2 bg-foreground text-background text-sm font-medium rounded-full hover:scale-105 transition-transform md:hidden">
                                                    Saber más
                                                </button>
                                            </div>
                                        </div>
